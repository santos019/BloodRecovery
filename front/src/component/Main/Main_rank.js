...
const Main_rank=(props)=>
{
    ...
    return(
        ...
        <div className="Main-rank-class">
            ...
            {sessionStorage.getItem("userId")===null?<img className="Main-rank-img-imgclass" src={BEFORELOGIN}></img>:<img className="Main-rank-img-imgclass" src={Test_img1}></img> }
            </div>
            <div className="Main-rank-text-container-class">
                <div className="Main-rank-text-class" onClick={()=>sendValue("랭킹")}>
                {sessionStorage.getItem("userId")===null?<Main_rank_text_before></Main_rank_text_before>:<Main_rank_text></Main_rank_text>}
            </div>
            </div>
        </div>
    )
