...
const Directed_main=(props)=>{
    ...
    const SelectBox = () => {
        return (
            <select value={frStatus} onChange={handleChange}>
                ...
                <option key="진행완료" value="진행완료">진행완료</option>
            </select>
        );
    };
    ...
    useEffect(() => {
        ...
        if(inputs.direct_main_bloodtype==="")
        {
            ...
            {   
                axios
                .get("http://bloodrecovery-lb-1423483073.us-east-2.elb.amazonaws.com:8000/direct?status="+selectStatus)//status상태만붙여주고
                ...
                axios
                .get("http://bloodrecovery-lb-1423483073.us-east-2.elb.amazonaws.com:8000/direct?sido="+getSi+"&sigungu="+getdo)//status상태만붙여주고, 시도 붙여주기
                .then(function(response){
            ...
            {   
                axios
                .get("http://bloodrecovery-lb-1423483073.us-east-2.elb.amazonaws.com:8000/direct?bloodType="+inputs.direct_main_bloodtype+"&status="+selectStatus)//status상태만붙여주고
                .then(function(response){
                ...
                axios
                .get("http://bloodrecovery-lb-1423483073.us-east-2.elb.amazonaws.com:8000/direct?bloodType="+inputs.direct_main_bloodtype+"&sido="+getSi+"&sigungu="+getdo+"&status="+selectStatus)//status상태만붙여주고, 시도 붙여주기
                .then(function(response){
        ...
        <div className="Directed-main-container">
            <div className="Directed-main-nav-container">
                ...
                <div className="Directed-main-nav-search-class">
                    <input type="text1" name="direct_main_bloodtype" onChange={onChange} className="Directed-main-input">
                    </input>
