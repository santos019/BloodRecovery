...
const Join_userdata = (props) => {
    ...
    const idoverlap = () => {
        ...
        if (idEXP.test(join_id) === false) {
            ...
            axios.get("http://bloodrecovery-lb-1423483073.us-east-2.elb.amazonaws.com:8000/user/idCheck/" + join_id)
                .then(function (res) {//false면 가입불가능 true면 가입가능
    ...
    const nicknameoverlap = () => {
        ...
        if (nicknameEXP.test(join_nickname) === false) {
            ...
            axios.get("http://bloodrecovery-lb-1423483073.us-east-2.elb.amazonaws.com:8000/user/nicknameCheck/" + join_nickname)
                .then(function (res) {//false면 가입불가능 true면 가입가능
                    console.log(res.data.result)
                    if (res.data.result === true) {
                        alert("사용가능한 닉네임입니다.")
    ...
    const valueCheck = () => {
        ...
        else if (resister1Check !== true || resister2Check !== true) { alert("주민등록번호를 확인해주세요.") }
    ...
    return (
        ...
        <div className="Join-userdata-class">
            <div className="Join-checkbox-class">
                ...
                <label className="Join-checkbox-text-class" htmlFor="Join-checkbox-checkbox-id">동의합니다</label>
            </div>
            <div className="Join-usesrdata-nickname">
                <div className="Join-userdata-nickname-text-class">
                    <div className="Textbox">
                        <span className="Textbox-name-class" htmlFor="Textbox-class">닉네임</span>
                ...
                <div className="Join-userdata-notice-class"  style={nicknameCheck===true?{color:"green"}:{color:"red"}}>
            ...
            <div className="Join-usesrdata-id-class">
                <div className="Join-userdata-nickname-text-class">
                    <div className="Textbox">
                        <span className="Textbox-name-class" htmlFor="Textbox-class">아이디</span>
                ...
                <div className="Join-userdata-notice2-class" style={idCheck===true?{color:"green"}:{color:"red"}}>
                    <p>영문, 숫자 '-' 포함 5~20자 이내</p>
                </div>
            </div>
            <div className="Join-userdata-nickname-text-class">
                <div className="Textbox">
                    <span className="Textbox-name-class" htmlFor="Textbox-class">비밀번호</span>
                    <input type="text1" name="join_password" value={join_password} onChange={onChange} className="Textbox-class">
                    </input>
                </div>
                
            </div>
            <div className="Join-userdata-notice3-class" style={passwordCheck===true?{color:"green"}:{color:"red"}}>
                    <p>영문, 숫자 '~!@#$%^&*()_' 포함 8~16자 이내</p>
                </div>
            <div className="Join-userdata-nickname-text-class">
                <div className="Textbox">
                    <span className="Textbox-name-class" htmlFor="Textbox-class">비밀번호 확인</span>
                    <input type="text1" name="join_passwordconfirm" value={join_passwordconfirm} onChange={onChange} className="Textbox-class">
                    </input>
                </div>
            </div>
            <div className="Join-userdata-notice4-class" style={passwordconfirmCheck===true?{color:"green"}:{color:"red"}}>
                    {passwordconfirmCheck===true?<p>비밀번호가 일치합니다.</p>:<p>비밀번호가 일치하지않습니다.</p>}
                </div>
            <div className="Join-userdata-nickname-text-class">
                <div className="Textbox">
                    <span className="Textbox-name-class" htmlFor="Textbox-class">성명</span>
                    <input type="text1" name="join_name" value={join_name} onChange={onChange} className="Textbox-class">
                    </input>
                </div>
            </div>
            <div className="Join-userdata-notice5-class" style={nameCheck===true?{color:"green"}:{color:"red"}}>
                    <p>한글 포함 2~20자 이내</p>
                </div>
            <div className="Join-userdata-nickname-text-class">
                <div className="Textbox">
                    <span className="Textbox-name-class" htmlFor="Textbox-class">주민등록번호</span>
